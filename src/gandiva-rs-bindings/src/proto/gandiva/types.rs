...
pub struct TreeNode {
    ...
    pub long_node: ::core::option::Option<LongNode>,
...
pub struct InNode {
    ...
    #[prost(message, optional, tag = "3")]
    pub long_values: ::core::option::Option<LongConstants>,
    #[prost(message, optional, tag = "4")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct LongConstants {
    #[prost(message, repeated, tag = "1")]
    pub long_values: ::prost::alloc::vec::Vec<LongNode>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
